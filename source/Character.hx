	...
	public function new(x:Float, y:Float, ?character:String = 'bf', ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			var tex = Paths.getSparrowAtlas('Actual_IRL_Death');
				...
				animation.addByPrefix('firstDeath', "Dead BF Death", 24, false);
				animation.addByPrefix('deathLoop', "Dead BF Brain Idle", 24, true);
				animation.addByPrefix('deathConfirm', "Dead BF Retry", 24, false);
