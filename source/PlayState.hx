...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
        ...
        healthBarBG = new AttachedSprite('dadBar');
	...
	public function reloadHealthBarColors() {
		healthBar.createImageFilledBar(Paths.image('bfBar'), FlxColor.WHITE);
		healthBar.createImageEmptyBar(Paths.image('dadBar'), FlxColor.WHITE);
		healthBar.updateBar();
	}
