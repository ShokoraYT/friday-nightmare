...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		//if(!FlxG.save.data.psykaEasterEgg || !easterEggEnabled) {
			gfDance = new FlxSprite(-200, -700);
			gfDance.frames = Paths.getSparrowAtlas('TitleBF');
			gfDance.animation.addByPrefix('bop', 'TitleBF bop', 24);
	...
	//	}
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				// credTextShit.screenCenter();
				case 5:
					createCoolText(['Atanon'], 45);
					//addMoreText('This game right below lol', -60);
					addMoreText('Shokora', 45);
