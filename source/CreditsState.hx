...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		['Shokora', 'shokora', 'Coding & Charts', 'https://twitter.com/PlayWarioLand4', '0xFFE600FF'],
		['Jester', 'jester', 'Sprites & Icons', '', '0xFFE3E7ED'],
		...
		[''],
		['Special Thanks'],
		['Punkinator7', 'face', 'Event Code', 'https://gamebanana.com/members/1687904', '0xFFFFB300'],
		[''],
		['Extra Keys Port'],
